        ...
        <Container>
          <div className="form flex my-4 gap-4 items-center">
            <Input
              ...
              change={(e) => setEnteredTodoName(e.target.value)}
              place="Todo name"
            />
            <Button
              click={isUpdate ? updateTodo : todoHandler}
              title={isUpdate ? "Update" : "Insert"}
            />
          </div>
          <div className="w-full">
            {todoList.length === 0 ? (
              ...
              todoList.map((todo) => (
                <div
                  key={todo.id}
                  className="py-2 px-4 rounded-md bg-gray-100 font-bold text-[#333] mb-4 flex items-center justify-between"
                >
                  <p>{todo.todo}</p>
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      click={() => editMode(todo.id, todo.todo)}
                      circle
                      color="green"
                      title={<BsPencil />}
                    />
